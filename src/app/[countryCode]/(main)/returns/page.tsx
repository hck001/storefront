...
export default function ReturnsPage() {
  ...
  const sections = [
    ["returnsPeriod", "returnsPeriodDesc"],
    ["returnsProcess", "returnsProcessDesc"],
    ["returnsRefund", "returnsRefundDesc"],
    ["returnsExceptions", "returnsExceptionsDesc"],
    ["returnsWarranty", "returnsWarrantyDesc"],
  ] as const
      ...
      <div className="relative py-16 sm:py-20 overflow-hidden" style={{ backgroundColor: "#0a0a0a" }}>
        ...
        <div className="content-container relative z-10 text-center">
          <div className="flex items-center gap-3 justify-center mb-4">
            ...
            <span className="text-[10px] uppercase tracking-[0.4em] text-[#C9A84C] font-bold">{t("pages.returnsTag")}</span>
            <div className="h-[1px] w-8 bg-[#C9A84C]/40" />
          </div>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-light tracking-tight text-white">{t("pages.returnsTitle")}</h1>
        </div>
      </div>
